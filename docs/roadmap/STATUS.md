...
|---|---|---|---|
| Phase 0 — Build discipline (`CGO_ENABLED=0`, `netgo`, `GODEBUG=netdns=go`) | In progress (2 of 6 items done) | ~½ day | L-001 (`08a195f`) + L-002 (`f51cba7`) merged 2026-05-08; L-003 (ldd CI assertion) is next |
