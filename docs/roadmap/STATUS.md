...
| Phase 5a — jsonl wiring (3 subcommands), OSCAL regression sweep, manpage, `agent --stdio` stub, deprecation cleanup | **IN PROGRESS** (3 of 6, 2026-05-10) | ~3 days | C-051 `3470703`, C-052 `9bc3d9c`, C-053 (OSCAL regression sweep) `1cde0b1` shipped. Next: C-054 (`kensa agent --stdio` placeholder). |
