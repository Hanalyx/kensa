...
| Phase 1 — Multi-call agent binary (`kensa agent --stdio`) | **IN PROGRESS** (L-007 `a787781`, L-008 `728d853`, L-009 `52a2f87`, all 2026-05-11; L-010 next) | 4–6 weeks | L-007 wirev1 + bridge shipped. L-008 echo loop + stub framing + subprocess E2E shipped. L-009 typed message schema (Apply/Capture/Rollback/Heartbeat) + api↔wire bridges shipped. L-010 (length-prefixed framing — supersedes L-008 stub) is the next pickable deliverable; L-011..L-032 follow in dep order. Gates Phases 2–7. |
