...
|---|---|---|---|
| Phase 0 — Build discipline (`CGO_ENABLED=0`, `netgo`, `GODEBUG=netdns=go`) | In progress (3 of 6 items done) | ~½ day | L-001 (`08a195f`) + L-002 (`f51cba7`) + L-003 (`798945d`) merged 2026-05-08; L-004 (glibc 2.28 container) is next |
