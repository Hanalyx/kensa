...
|---|---|---|---|
| Phase 0 — Build discipline (`CGO_ENABLED=0`, `netgo`, `GODEBUG=netdns=go`) | In progress (1 of 6 items done) | ~½ day | L-001 merged `08a195f` 2026-05-08; L-002 (netgo + GODEBUG=netdns=go) is next |
