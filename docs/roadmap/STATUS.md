...
| Phase 4 — systemd D-Bus for service handlers | **IN PROGRESS: D-007 (`4e3185e`) + D-008 (`7d2ca4b`) + D-009/D-010 (`f731a20`) done 2026-05-13. Option 3 rescoping accepted: Phase 4 = D-Bus primitive layer only; handler ports defer to v1.x. 2 deliverables remain: D-011 (start + stop + JobRemoved, restores AC-05/C-03) + D-012 (Phase 4 close docs).** | ~2 days remaining | D-011 next — first job-producing D-Bus ops; un-defers AC-05/C-03. |
