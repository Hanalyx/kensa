...
| Phase 5a — jsonl wiring (3 subcommands), OSCAL regression sweep, manpage, `agent --stdio` stub, deprecation cleanup | **IN PROGRESS** (1 of 6, 2026-05-10) | ~3 days | C-051 (`history --format jsonl`) `3470703` shipped. Next: C-052 (jsonl on `list sessions` + `info` QUERY mode). |
