...
| Phase 5a — jsonl wiring (3 subcommands), OSCAL regression sweep, manpage, `agent --stdio` stub, deprecation cleanup | **IN PROGRESS** (2 of 6, 2026-05-10) | ~3 days | C-051 `3470703`, C-052 (`list sessions` + `info` QUERY jsonl) `9bc3d9c` shipped. Next: C-053 (OSCAL regression sweep). |
