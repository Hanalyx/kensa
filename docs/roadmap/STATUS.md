...
| Phase 3 — Deadman timer rebuild (`timerfd(CLOCK_BOOTTIME)`, `pidfd_open`, `epoll`, `signalfd`) | **IN PROGRESS: 6/7 Phase-3 deliverables done; D-006 + P-012 follow-up pending** | ~2 weeks → ~1 day actual through D-005 | **Done:** P-011 (env-var flip, `02bd68d`), D-001 (timerfd, `f804be6`), D-002 (pidfd+probe, `c857b93`), D-003 (signalfd+prctl, `f8facf9`), D-004 (epoll integrator, `0abad1b`), D-005 (Armer rewrite + 2nd-round fix-up, `52a0f21` after `a9d95c3` peer review caught 3 P0s+4 P1s), Q4 rename (`761829b`). **Pending:** D-006 (fuzz harness + Phase 3 close — needs live-host CONTRIBUTING.md discipline). **Phase 3 follow-up (post-D-006):** P-012 specter `coverage --strict` migration (67 specs → Convention B `t.Log` annotations to surface the runner-visible `@spec`/`@ac` markers). |
