...
|---|---|---|---|
| Phase 0 — Build discipline (`CGO_ENABLED=0`, `netgo`, `GODEBUG=netdns=go`) | Not started | ~½ day | Ship independently of everything else; cheapest immediate win in this plan |
