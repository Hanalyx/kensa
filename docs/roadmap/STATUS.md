...
| Phase 4 — Session model in store + `kensa diff`, framework `kensa coverage`, `kensa list frameworks`, `kensa info`, `--stats`/`--prune` | **IN PROGRESS** (11 of 12, 2026-05-09) | ~2 weeks | C-039 `21885a7`, C-040 `391d878`, C-041 `aea016f`, C-042 `2b0a61e`, C-043 `3a69700`, C-044 `33db2e4`, C-045 `a194195`, C-046 `5c1f97f`, C-047 `389534e`, C-048 `be4820c`, C-049 (rollback session-aware) `c99ca33` shipped. Next: C-050 Phase 4 close (help-grouping + smoke + spec corpus). Spec corpus 50→62 over the phase so far. |
