...
| Phase 4 — Session model in store + `kensa diff`, framework `kensa coverage`, `kensa list frameworks`, `kensa info`, `--stats`/`--prune` | **IN PROGRESS** (7 of 12, 2026-05-09) | ~2 weeks | C-039 `21885a7`, C-040 `391d878`, C-041 `aea016f`, C-042 `2b0a61e`, C-043 `3a69700`, C-044 `33db2e4`, C-045 (framework-coverage report) `a194195` shipped. Next: C-046 `kensa list frameworks`. Spec corpus 50→58 over the phase so far. |
