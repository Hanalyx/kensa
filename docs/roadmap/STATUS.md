...
| Phase 2 — File Atomicity Primitives (`renameat2`, `O_TMPFILE`, `fsync`) | **RATIFIED 2026-05-11; P-001 next** | ~2 weeks | P-001..P-006 in DELIVERABLES.md. P-001 (fsatomic package, no handler edits) is ready for loop pickup. P-002..P-005 (file_content, file_absent, config_set, config_set_dropin migrations) parallel after P-001. P-006 (contract amendment) closes the phase. file_permissions chmod stays atomic at syscall level, doesn't need migrating. |
