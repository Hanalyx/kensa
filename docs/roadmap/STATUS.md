...
| Phase 5a — jsonl wiring (3 subcommands), OSCAL regression sweep, manpage, `agent --stdio` stub, deprecation cleanup | **IN PROGRESS** (founder-ratified 2026-05-10) | ~3 days | C-051..C-056 broken out. Signer-independent; ships on its own. v1.0 will make no cryptographic-signing claims. |
