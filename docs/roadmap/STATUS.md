...
| Phase 1 — Multi-call agent binary (`kensa agent --stdio`) | **IN PROGRESS** (L-007 `a787781`, L-008 `728d853`, L-009 `52a2f87`, L-010 `ceb6c72`, L-011 `f523ed9`, all 2026-05-11; L-012 next) | 4–6 weeks | L-007..L-011 shipped: wirev1 + bridge + echo loop + typed message schema + production framing v2 + controller-side AgentClient (typed-RPC over framed pipes). L-012 (version handshake on session start) is the next pickable deliverable; L-013..L-032 follow in dep order. Gates Phases 2–7. |
