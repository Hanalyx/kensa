...
| `kensa check` | [`check.md`](check.md) | DONE — full Phase 3.5 flag surface incl. inventory mode |
| `kensa remediate` | [`remediate.md`](remediate.md) | DONE — full Phase 3.5 flag surface (single-host only) |
...
| **CLI Phase 3.5 close (current)** | **99** |
