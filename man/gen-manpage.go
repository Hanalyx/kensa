...
// Usage:
//
//	go run man/gen-manpage.go [-bin path/to/kensa]
//
...
func main() {
	...
	headerPath := flag.String("header", "man/kensa.1.header.roff", "header roff path")
	footerPath := flag.String("footer", "man/kensa.1.footer.roff", "footer roff path")
	flag.Parse()
