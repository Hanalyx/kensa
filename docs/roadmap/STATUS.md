...
| Phase 1 — Multi-call agent binary (`kensa agent --stdio`) | **IN PROGRESS** (L-007 `a787781`, L-008 `728d853`, L-009 `52a2f87`, L-010 `ceb6c72`, all 2026-05-11; L-011 next) | 4–6 weeks | L-007..L-010 shipped: wirev1 + bridge + echo loop + typed message schema + production framing v2 (type-byte discriminator, configurable max-size, Validator injection point). L-011 (controller-side AgentTransport adapter) is the next pickable deliverable; L-012..L-032 follow in dep order. Gates Phases 2–7. |
