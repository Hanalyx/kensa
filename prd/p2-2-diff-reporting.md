...
- `aegis diff SESSION1 SESSION2` command compares two stored sessions
...
## Features
- `aegis diff 1 2` - Compare session 1 (older) to session 2 (newer)
- `aegis diff 1 2 --host 192.168.1.100` - Filter diff to specific host
- `aegis diff 1 2 --json` - JSON output for automation
- `aegis diff 1 2 --show-unchanged` - Include unchanged rules
