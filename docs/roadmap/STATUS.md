...
| Phase 2 — File Atomicity Primitives (`renameat2`, `O_TMPFILE`, `fsync`) | **READY FOR RATIFICATION** | ~2 weeks | Breakdown drafted (P-001..P-006 in `docs/roadmap/PHASE-2-BREAKDOWN.md`). P-001 (fsatomic package) → P-002..P-005 (handler migrations, parallel) → P-006 (contract amendment + docs). |
