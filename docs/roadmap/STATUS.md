...
| Phase 5a — jsonl wiring (3 subcommands), OSCAL regression sweep, manpage, `agent --stdio` stub, deprecation cleanup | **IN PROGRESS** (5 of 6, 2026-05-10) | ~3 days | C-051 `3470703`, C-052 `9bc3d9c`, C-053 `1cde0b1`, C-054 `23b19c5`, C-055 (`kensa(1)` manpage) `4d9969f` shipped. Next: C-056 (Phase 5a close). |
