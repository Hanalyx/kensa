...
var deferredDuplicateCites = map[string]string{
	...
	"cis|ubuntu22|5.3.3.2.3": "KEEP (compound control): the four pam-pwquality credit rules (dcredit, ucredit, lcredit, ocredit) jointly satisfy one CIS Ubuntu 22.04 v3.0.0 5.3.3.2.3 \"password complexity\" section (which bundles minclass + all four credits); re-homed here from the mis-numbered 5.4.1.x block after SOT verification, matching the rhel8/9/10 re-homes (dcredit was already correct here; ucredit/lcredit/ocredit were the stranded ones)",
	"cis|ubuntu24|5.3.3.2.3": "KEEP (compound control): the four pam-pwquality credit rules (dcredit, ucredit, lcredit, ocredit) jointly satisfy one CIS Ubuntu 24.04 v2.0.0 5.3.3.2.3 \"password complexity\" section (which bundles minclass + all four credits); re-homed here from the mis-numbered 5.4.1.x block after SOT verification, matching the rhel8/9/10 re-homes (dcredit was already correct here; ucredit/lcredit/ocredit were the stranded ones)",
