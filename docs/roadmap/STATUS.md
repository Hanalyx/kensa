...
| Phase 1 — Multi-call agent binary (`kensa agent --stdio`) | **UNBLOCKED** (L-007 ratified protobuf 2026-05-11) | 4–6 weeks | L-007 implementation (scaffold `proto/`, pin `protoc-gen-go`, codegen CI step) is the first deliverable; L-008..L-032 then pickable in dep order. Gates Phases 2–7. |
