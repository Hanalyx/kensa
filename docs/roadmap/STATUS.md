...
| Phase | Status | Estimated size | Next action |
|---|---|---|---|
| Phase 1 — pflag swap, `-h, --help`, `--version`, exit codes 0/1/2 | In progress (3 of 10 items done) | ~2 days | C-001 (`cde364d`) + C-002 (`f91980d`) + C-003 (`f0a3975`) merged 2026-05-08. C-004 (runRemediate/runRollback/runHistory/runPlan/runCoverage/runVersion) is next |
