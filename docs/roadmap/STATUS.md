...
| Phase 4 — systemd D-Bus for service handlers | **PLANNING LANDED 2026-05-13: privilege model Option C ratified; 5 deliverables D-007..D-011 broken out in DELIVERABLES.md; helper-interface spec at `specs/agent/systemd-helper.spec.yaml` (tier 1, 6 constraints, 11 ACs).** | ~4 days execution | D-007 (helper scaffolding) is next. `coreos/go-systemd/v22 v22.7.0` + `godbus/dbus/v5 v5.1.0` portability gates pre-validated locally (CGO_ENABLED=0, -tags netgo, ldd static). |
